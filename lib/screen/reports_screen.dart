  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          centerTitle: true,
          elevation: 1,
          leading:isMohref?IconButton(
              onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (_)=> RatingScreen(
                  reportId: reportID,
                )));
              },
              icon: const Icon(Icons.star,color: Colors.yellow,)):Container(),
        actions: [
          IconButton(
              onPressed: (){
