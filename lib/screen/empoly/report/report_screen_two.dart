                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(children: [
                            ...
                            (state is LoadingGetMosques &&
                                    cubit.mosquesName.isEmpty)
                            ...
                            (state is LoadingGetDataMosque)
                                ...
                                : Column(
                                    ...
                                    children: [
                                      showDate(
                                          name: 'الــمــؤذن',
                                          date: cubit.mosqueDate == null
                                              ? ''
                                              : cubit.mosqueDate!.moazin),
                                      showDate(
                                          name: 'رقـــم الــجــوال الــمــؤذن',
                                          date: cubit.mosqueDate == null
                                              ? ''
                                              : cubit.mosqueDate!.moazin_phone),
                                      showDate(
                                          name: 'الإمـــام',
                                          date: cubit.mosqueDate == null
                                              ? ''
                                              : cubit.mosqueDate!.imam),
                                      showDate(
                                          name: 'رقـــم الــجــوال الإمـــام',
                                          date: cubit.mosqueDate == null
                                              ? ''
                                              : cubit.mosqueDate!.imam_phone),
                                      showDate(
                                          name: 'الـــخــطـيـب',
                                          date: cubit.mosqueDate == null
                                              ? ''
                                              : cubit.mosqueDate!.kahteeb),
                                      showDate(
                                          name:
                                              'رقـــم الــجــوال الـــخــطـيـب',
                                          date: cubit.mosqueDate == null
                                              ? ''
                                              : cubit
                                                  .mosqueDate!.kahteeb_phone),
                                      showDate(
                                          name: 'الـــخادم',
                                          date: cubit.mosqueDate == null
                                              ? ''
                                              : cubit.mosqueDate!.servant_name),
                                      showDate(
                                          name: 'رقـــم الــجــوال الـــخادم',
                                          date: cubit.mosqueDate == null
                                              ? ''
                                              : cubit
                                                  .mosqueDate!.servant_number),
                                      showDate(
                                          name: 'الحي',
                                          date: cubit.mosqueDate == null
                                              ? ''
                            ...
                            InkWell(
                              onTap: () {
                                if (cubit.mosqueDate != null &&
                                    mosque != null) {
                                  navigatorTo(
                                      context: context,
                                      widget: ReportScreenThree(
                                        address: address,
                                        createdAt: createdAt,
                                        lat: lat,
                                        lng: lng,
