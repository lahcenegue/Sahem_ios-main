...
class ReportScreenThree extends StatelessWidget {
  ...
  List<String> alqarah = [
    "    الخطيب الإلتزام / القراءة النجدية",
                                      ...
                                      child: Stack(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: ClipRRect(
                                              borderRadius: BorderRadius.circular(10),
                                              child: cubit.file1==null?Image.asset('assets/images/new.png',
                                      ...
                                      child: Stack(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: ClipRRect(
                                              borderRadius: BorderRadius.circular(10),
                                              child: cubit.file2==null?Image.asset('assets/images/new.png',
                                      ...
                                      child: Stack(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: ClipRRect(
                                              borderRadius: BorderRadius.circular(10),
                                              child: cubit.file3==null?Image.asset('assets/images/new.png',
                                  ...
                                  onTap: () async {
                                    if(formKey.currentState!.validate()&&oratorString!=null){
                                      navigatorTo(context: context,widget: PreviewReport(
                                        ...
                                        imageOne: cubit.base641,
                                        imageOneName: cubit.imagePath1,
                                        imageTwo: cubit.base642,
                                        imageTwoName: cubit.imagePath2,
                                        imageThree: cubit.base643,
                                        imageThreeName: cubit.imagePath3,
